...
public class PhotoPreview extends LinearLayout implements OnClickListener {
	...
	public PhotoPreview(Context context) {
		super(context);
		LayoutInflater.from(context).inflate(R.layout.photoselector_view_preview, this, true);
	...
	private void loadImage(String path) {
		ImageLoader.getInstance().loadImage(path, new SimpleImageLoadingListener() {
			...
			public void onLoadingFailed(String imageUri, View view, FailReason failReason) {
				ivContent.setImageDrawable(getResources().getDrawable(R.drawable.photoselector_ic_picture_loadfailed));
				pbLoading.setVisibility(View.GONE);
			}
		});
	}
