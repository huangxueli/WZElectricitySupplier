 ...
 * 环网单元
 */
public class HWRecord extends DeviceRecord{
	
	public static Field ZD_NAME = new Field("环网柜单元名称", "TEXT");
	...
	public HWRecord(String Name, String Circuit, String BackupIntervalNum, String OutIntervalNum, 
	...
	public String getDeviceType() {
		mDeviceType = DeviceType.DeviceHW;
